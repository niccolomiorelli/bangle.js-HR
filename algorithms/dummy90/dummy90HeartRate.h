 ...
 *
 * ----------------------------------------------------------------------------
 * Dummy90 Heart Rate Algorithm
 * ----------------------------------------------------------------------------
 */

#ifndef DUMMY90_HEARTRATE_H
#define DUMMY90_HEARTRATE_H

#include "../../types.h"

/**
 * Initalise and reset the heart rate algorithm
 */
 ...
 *
 * returns: the heart rate value (always 900 = 90 bpm).
 */
